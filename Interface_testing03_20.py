...
import operator
from Try1_2 import Init, Person, Train, Station, AllTrain
...
class choose2():
    ...
    def Find(self):
        ...
        Day=Label(window_temp2,text="出发日期");Day.grid(row=1,column=1)
    ...
    def Search_T(self):
        ...
        def Get_S():
            if '' in [Get2.get(), Get3.get(), Get4.get()]:
                ...
                def Check_Sure():
                    ...
                    A4 = tk.IntVar()
                    A5 = tk.IntVar()
                    Checkbutton1 = Checkbutton(window_temp_new, text="A座",variable=A1,onvalue=1,offvalue = 0)
                    Checkbutton1.grid(row=1, column=1)
                    Checkbutton2 = Checkbutton(window_temp_new, text="B座",variable=A2,onvalue=1,offvalue = 0)
                    Checkbutton2.grid(row=1, column=2)
                    Checkbutton3 = Checkbutton(window_temp_new, text="C座",variable=A3,onvalue=1,offvalue = 0)
                    Checkbutton3.grid(row=2, column=1)
                    Checkbutton4 = Checkbutton(window_temp_new, text="D座",variable=A4,onvalue=1,offvalue = 0)
                    Checkbutton4.grid(row=2, column=2)
                    Checkbutton5 = Checkbutton(window_temp_new, text="E座" ,variable=A5,onvalue=1,offvalue = 0)
        ...
        def Buy():
            ...
            Checkbutton1=Checkbutton(window_temp_new,text="A座",variable=A1);Checkbutton1.grid(row=1,column=1)
            Checkbutton2=Checkbutton(window_temp_new,text="B座",variable=A2);Checkbutton2.grid(row=1,column=2)
            Checkbutton3=Checkbutton(window_temp_new,text="C座",variable=A3);Checkbutton3.grid(row=2,column=1)
            Checkbutton4=Checkbutton(window_temp_new,text="D",variable=A4);Checkbutton4.grid(row=2,colmun=2)
            Checkbutton5=Checkbutton(window_temp_new,text="E",variable=A5);Checkbutton5.grid(row=3,column=1)
            def Que():
